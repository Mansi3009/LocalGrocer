                    ...
                    <div class="row register-form">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="hidden" name="userid" class="form-control" placeholder="First Name *" value="{{ $user->id }}" />
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="number" name="contact_no" class="form-control" placeholder="Contact no *" value="{{ $user->contact_no }}" />
                            </div>
                    
                            <div class="form-group">
                                <input type="password" name="password" maxlength="8" minlength="6" class="form-control" placeholder="Password *" value="{{ $user->password }}" />
                            </div>
